...
**Native apps** are those written using the iOS, Windows or Android SDKs. **Mobile web apps** are web apps accessed using a mobile browser (Appium supports
...
multiple platforms (iOS, Android, Windows), using the same API. This enables code reuse between iOS, Windows, and Android testsuites.
